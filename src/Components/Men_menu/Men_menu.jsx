...
//         <h1>X</h1>
//             <div className="firstShop">
//                 <img className="images1" src={props.data.collection.image} alt="pic"/>
//                 <h1 className="names1">{props.data.collection.name}</h1>
//                 <h2 className="prices1">{props.data.collection.price}</h2>
//                 <button className="aboutProduct">Buy</button>
//             </div>
//         </div>
//     )
// }